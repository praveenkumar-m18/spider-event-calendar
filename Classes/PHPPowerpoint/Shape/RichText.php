...
require_once $base_path.'/PHPPowerPoint/Shape/RichText/ITextElement.php';

/** PHPPowerPoint_Shape_RichText_TextElement */
require_once $base_path.'/PHPPowerPoint/Shape/RichText/TextElement.php';

/** PHPPowerPoint_Shape_RichText_Run */
require_once $base_path.'/PHPPowerPoint/Shape/RichText/Run.php';

/** PHPPowerPoint_Shape_RichText_Break */
require_once $base_path.'/PHPPowerPoint/Shape/RichText/Break.php';

/** PHPPowerPoint_Style_Alignment */
require_once $base_path.'/PHPPowerPoint/Style/Alignment.php';
