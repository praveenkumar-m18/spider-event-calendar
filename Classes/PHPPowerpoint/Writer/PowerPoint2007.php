...
/** PHPPowerPoint */
require_once $base_path.'/PHPPowerPoint.php';

/** PHPPowerPoint_HashTable */
require_once $base_path.'/PHPPowerPoint/HashTable.php';

/** PHPPowerPoint_IComparable */
require_once $base_path.'/PHPPowerPoint/IComparable.php';

/** PHPPowerPoint_Slide */
require_once $base_path.'/PHPPowerPoint/Slide.php';

/** PHPPowerPoint_IWriter */
require_once $base_path.'/PHPPowerPoint/Writer/IWriter.php';

/** PHPPowerPoint_Shared_XMLWriter */
require_once $base_path.'/PHPPowerPoint/Shared/XMLWriter.php';

/** PHPPowerPoint_Writer_PowerPoint2007_WriterPart */
require_once $base_path.'/PHPPowerPoint/Writer/PowerPoint2007/WriterPart.php';

/** PHPPowerPoint_Writer_PowerPoint2007_ContentTypes */
require_once $base_path.'/PHPPowerPoint/Writer/PowerPoint2007/ContentTypes.php';

/** PHPPowerPoint_Writer_PowerPoint2007_DocProps */
require_once $base_path.'/PHPPowerPoint/Writer/PowerPoint2007/DocProps.php';

/** PHPPowerPoint_Writer_PowerPoint2007_Rels */
require_once $base_path.'/PHPPowerPoint/Writer/PowerPoint2007/Rels.php';

/** PHPPowerPoint_Writer_PowerPoint2007_Theme */
require_once $base_path.'/PHPPowerPoint/Writer/PowerPoint2007/Theme.php';

/** PHPPowerPoint_Writer_PowerPoint2007_Presentation */
require_once $base_path.'/PHPPowerPoint/Writer/PowerPoint2007/Presentation.php';

/** PHPPowerPoint_Writer_PowerPoint2007_Slide */
require_once $base_path.'/PHPPowerPoint/Writer/PowerPoint2007/Slide.php';

/** PHPPowerPoint_Writer_PowerPoint2007_Drawing */
require_once $base_path.'/PHPPowerPoint/Writer/PowerPoint2007/Drawing.php';

/** PHPPowerPoint_Writer_PowerPoint2007_LayoutPack */
require_once $base_path.'/PHPPowerPoint/Writer/PowerPoint2007/LayoutPack.php';

/** PHPPowerPoint_Writer_PowerPoint2007_LayoutPack_Default */
require_once $base_path.'/PHPPowerPoint/Writer/PowerPoint2007/LayoutPack/Default.php';
