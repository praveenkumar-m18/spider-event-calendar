...
require_once $base_path.'/PHPPowerPoint/Writer/PowerPoint2007.php';
...
/** PHPPowerPoint_Shape */
require_once $base_path.'/PHPPowerPoint/Shape.php';

/** PHPPowerPoint_Shape_RichText */
require_once $base_path.'/PHPPowerPoint/Shape/RichText.php';

/** PHPPowerPoint_Shape_BaseDrawing */
require_once $base_path.'/PHPPowerPoint/Shape/BaseDrawing.php';

/** PHPPowerPoint_Shape_Drawing */
require_once $base_path.'/PHPPowerPoint/Shape/Drawing.php';

/** PHPPowerPoint_Shape_MemoryDrawing */
require_once $base_path.'/PHPPowerPoint/Shape/MemoryDrawing.php';

/** PHPPowerPoint_Shared_Font */
require_once $base_path.'/PHPPowerPoint/Shared/Font.php';

/** PHPPowerPoint_Shared_String */
require_once $base_path.'/PHPPowerPoint/Shared/String.php';
