...
<html>
  ...
  <style type='text/css'>
    ...
    #bigcalendar<?php echo $many_sp_calendar; ?> .views {
      float: right;
      background-color: #6495ED<?php //echo $views_tabs_bg_color; ?>;
      min-height: 25px;
      min-width: 70px;
      margin-left: 2px;
      text-align: center;
      ...
      <tr>
        <td>
          ...
          <div id="views_tabs" style="width: 100%;<?php echo $display ?>">
            <div class="views" style="<?php if (!in_array('day', $views) AND $defaultview != 'day') echo 'display:none;'; if ($view == 'bigcalendarday') echo 'background-color:#0071C5 !important;top:0;'; ?>"
              ...
              <td width="100%" style="padding:0; margin:0;">
                <table cellpadding="0" cellspacing="0" border="0" style="border-spacing:0; font-size:12px; margin:0; padding:0; width:100%;" >
                  <tr style="height:40px; width:100%;">
                    <td class="top_table" align="center" colspan="7" style="position: relative;padding:0; margin:0; background-color:#0071C5<?php //echo $bg_top; ?> !important;height:20px; background-repeat: no-repeat;background-size: 100% 100%;">
