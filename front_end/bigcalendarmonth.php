...
<html>
  <head>
	  <style type='text/css'> 
		...
		#bigcalendar<?php echo $many_sp_calendar; ?> .views {
		  float: right;
		  background-color: #6495ED<?php //echo $views_tabs_bg_color; ?> !important;
		  min-height: 25px;
		  min-width: 70px;
		  margin-left: 2px;
		  text-align: center;
	...
	<tbody>
	<tr>
	<td>Month:  <input style="width: 40%; height: 15px;" type="text" /></td>
	<td>Camapign:  <input style="width: 40%; height: 15px;" type="text" /></td>
	<td>Owner:  <input style="width: 40%; height: 15px;" type="text" /></td>
	<td>Channel:  <input style="width: 40%; height: 15px;" type="text" /></td>
	<td>Category:<select style="width: 50%; height: 15px;">
	<option value="1">D&amp;I</option>
	<option value="2">Benefits,Care &amp; Services</option>
	<option value="3">Hiring Ramps</option>
	<option value="4">Lists and Awards</option>
	</select></td>
	</tr>
	</tbody>
	</table>-->
  <!--<form action="" name="search_cal" method="POST">
	<table style="width:165%">
	<tr>
	<td>Month:  <input style="width: 12%; height:25px;" type="text" /> 
	Camapign:  <input style="width: 12%; height:25px;" type="text" />
	Owner:  <input style="width: 12%; height:25px;" type="text" />
	Channel:  <input style="width: 12%; height:25px;" type="text" />
	Category: <select style="width: 16%;height:55px; " name="cat_cal" onchange="this.form.submit();">
	<option value="">--All Categories--</option>
	<option value="1">Benefits,Care&amp;Services</option>
	<option value="2">Hiring Ramps</option>
	<option value="3">D&amp;I</option>
	<option value="4">List &amp; Awards</option>
  ...
  <div style="width:100%;">
    ...
    <table cellpadding="0" cellspacing="0" style="width:145%;">
      <tr>
        <td>		
          <div id="views_tabs" style="<?php echo $display ?>;width: 100%;">
            ...
            <div class="views" style="<?php if (!in_array('month', $views) AND $defaultview != 'month') echo 'display:none;'; if ($view == 'bigcalendarmonth') echo 'background-color:#0071C5 !important;top:0;'; ?>"
              onclick="showbigcalendar('bigcalendar<?php echo $many_sp_calendar; ?>', '<?php echo add_query_arg(array(
                ...
                <table cellpadding="0" cellspacing="0" border="0" style="border-spacing:0; font-size:12px; margin:0; padding:0; width:100%;">
                  <tr style="height:40px; width:100%;">
                    <!--<td class="top_table" align="center" colspan="7" style="position: relative;padding:0; margin:0; background-color:<?php //echo $bg_top; ?>;height:20px; background-repeat: no-repeat;background-size: 100% 100%; border: 0 !important;">-->
                      <td class="top_table" align="center" colspan="7" style="position: relative;padding:0; margin:0; background-color:#0071C5<?php //echo $bg_top; ?>;height:20px; background-repeat: no-repeat;background-size: 100% 100%; border: 0 !important;">
                          ...
                          <td width="10%">
                            <div onclick="javascript:showbigcalendar('bigcalendar<?php echo $many_sp_calendar; ?>','<?php 
                              echo add_query_arg(array(
								...
								'cat_ids' => $cat_ids,
                                'widget' => $widget,
                                ), $site_url);?>','<?php echo $many_sp_calendar; ?>','<?php echo $widget; ?>')" style="text-align:center; cursor:pointer; width:100%; background-color:#6495ED<?php //echo $years_bgcolor; ?>;">
                  ...
                  <tr align="center" height="<?php echo $week_days_cell_height; ?>" style="background-color:#0071C5;<?php //echo $weekdays_bg_color; ?> !important;">
                    <?php if ($weekstart == "su") { ?>
                      <td class="weekdays" style="width:14.2857143%; color:<?php echo $color_week_days;?>; margin:0; padding:0;background-color:#0071C5;<?php //echo $weekday_sunday_bg_color; ?> !important">
                        <div class="calbottom_border" style="text-align:center; margin:0; padding:0;"><b class="week_days"><?php echo __('Sun', 'sp_calendar'); ?> </b></div>
                      </td>
                    <?php } ?>
                    <td class="weekdays" style="width:14.2857143%; color:<?php echo $color_week_days; ?>; margin:0; padding:0">
                      <div class="calbottom_border" style="text-align:center; margin:0; padding:0;"><b class="week_days"><?php echo __('Mon', 'sp_calendar'); ?> </b></div>
                    </td>
                    <td class="weekdays" style="width:14.2857143%; color:<?php echo $color_week_days; ?>; margin:0; padding:0">
                      <div class="calbottom_border" style="text-align:center; margin:0; padding:0;"><b class="week_days"><?php echo __('Tue', 'sp_calendar'); ?> </b></div>
                    </td>
                    <td class="weekdays" style="width:14.2857143%; color:<?php echo $color_week_days; ?>; margin:0; padding:0">
                      <div class="calbottom_border" style="text-align:center; margin:0; padding:0;"><b class="week_days"><?php echo __('Wed', 'sp_calendar'); ?> </b></div>
                    </td>
                    <td class="weekdays" style="width:14.2857143%; color:<?php echo $color_week_days; ?>; margin:0; padding:0">
                      <div class="calbottom_border" style="text-align:center;margin:0; padding:0;"><b class="week_days"><?php echo __('Thu', 'sp_calendar'); ?> </b></div>
                    </td>
                    <td class="weekdays" style="width:14.2857143%; color:<?php echo $color_week_days; ?>; margin:0; padding:0">
                      <div class="calbottom_border" style="text-align:center;margin:0; padding:0;"><b class="week_days"><?php echo __('Fri', 'sp_calendar'); ?> </b></div>
                    </td>
                    <td class="weekdays" style="width:14.2857143%;	color:<?php echo $color_week_days; ?>; margin:0; padding:0">
                      <div class="calbottom_border" style="text-align:center; margin:0; padding:0;"><b class="week_days"><?php echo __('Sat', 'sp_calendar'); ?> </b></div>
                    </td>
                    <?php if ($weekstart == "mo") { ?>			 
...
{
?>
<li class="spider_categories">
<p id="category<?php echo $category->id ?>" style="background-color:#<?php echo str_replace('#','',$category->color); ?> !important" onclick="showbigcalendar('bigcalendar<?php echo $many_sp_calendar; ?>', '<?php echo add_query_arg(array(
                'action' => 'spiderbigcalendar_month',
                'theme_id' => $theme_id,
                'calendar' => $calendar_id,
                'select' => $view_select,
