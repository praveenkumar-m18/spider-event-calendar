...
#views_tabs_select 
{
 ...
 <!--<table style="width:165%">
	...
	Category: <select style="width: 16%; height:55px;">
      ...
      <tr>
        <td>
          <div id="views_tabs" style="width: 100%;<?php echo $display; ?>">
            ...
            <div class="views" style="<?php if (!in_array('week', $views) AND $defaultview != 'week') echo 'display:none;'; if ($view == 'bigcalendarweek') echo 'background-color:#0071C5 !important;top:0;'; ?>"
              onclick="showbigcalendar('bigcalendar<?php echo $many_sp_calendar; ?>', '<?php echo add_query_arg(array(
              ...
              <td width="100%" style="padding:0; margin:0">
                <table cellpadding="0" cellspacing="0" border="0" style="border-spacing:0; font-size:12px; margin:0; padding:0; width:100%;">
                  <tr style="height:40px; width:100%;">
                    <td class="top_table" align="center" colspan="7" style="position: relative;padding:0; margin:0; background-color:#0071C5<?php //echo $bg_top; ?>;height:20px; background-repeat: no-repeat;background-size: 100% 100%;">
                                ...
                                <td width="15%">
                                  <div onclick="javascript:showbigcalendar('bigcalendar<?php echo $many_sp_calendar; ?>','<?php 
                                    echo add_query_arg(array(
									  ...
									  'cat_ids' => $cat_ids,
                                      'widget' => $widget,
                                      ), $site_url);?>','<?php echo $many_sp_calendar; ?>','<?php echo $widget; ?>')" style="text-align:center; cursor:pointer; width:100%; background-color:#6495ED <?php //echo hex_to_rgb($views_tabs_bg_color, 0.4) ?>;">
